...
public class SpeechDemo extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SpeechUtility.createUtility(SpeechDemo.this, SpeechConstant.APPID +"=5e081fe7");
    ...
    private void initLayout() {
        ...
        //Button mbutton = (Button)findViewById(R.id.nlp_start);
