...
public class WakeupDemo extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wakeupdemo);
    ...
    private String getResource() {
        final String resPath = ResourceUtil.generateResourcePath(WakeupDemo.this, RESOURCE_TYPE.assets, "ivw/"+"5e081fe7"+".jet");
